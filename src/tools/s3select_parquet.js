...
class S3SelectStream extends Transform {
    ...
    async select_parquet() {
        ...
        //this.s3select.select_parquet_start();
        const string = this.s3select.select_parquet_start();
        console.log("select parquest steam res = ", string);
